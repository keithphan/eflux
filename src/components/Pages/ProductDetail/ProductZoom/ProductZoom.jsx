                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6">
                            <div className="product-zoom-area">
                                <span className="batch">30%</span>
                                    ...
                                    >
                                        <div><img src="/images/product-detail/01.jpg" alt=""
                                                className="img-fluid blur-up lazyload image_zoom_cls-0"/></div>
                                        <div><img src="/images/product-detail/02.jpg" alt=""
                                                className="img-fluid blur-up lazyload image_zoom_cls-1"/></div>
                                        <div><img src="/images/product-detail/03.jpg" alt=""
                        ...
                        <div className="col-lg-6">
                            <div className="product-details-content">
                                ...
                                <a href="abc.html" className="cata"></a>
                                <h2>{ product.title }</h2>
